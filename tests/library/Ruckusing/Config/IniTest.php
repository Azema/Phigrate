...
class Ruckusing_Config_IniTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_iniFileConfig = FIXTURES_PATH . '/config/config.ini';
        $this->_iniFileAllSectionsConfig = FIXTURES_PATH . '/config/allsections.ini';
        $this->_iniFileCircularConfig = FIXTURES_PATH . '/config/circular.ini';
        $this->_iniFileMultipleInheritanceConfig = FIXTURES_PATH . '/config/multipleinheritance.ini';
        $this->_iniFileSeparatorConfig = FIXTURES_PATH . '/config/separator.ini';
        $this->_nonReadableConfig = FIXTURES_PATH . '/config/nonreadable.ini';
        $this->_iniFileNoSectionsConfig = FIXTURES_PATH . '/config/nosections.ini';
        $this->_iniFileInvalid = FIXTURES_PATH . '/config/invalid.ini';
    }
