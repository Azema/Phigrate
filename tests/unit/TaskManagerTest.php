...
class TaskManagerTest extends PHPUnit_Framework_TestCase
{
    protected function setUp()
    {
        ...
        if (! is_array($ruckusing_db_config) 
            || !array_key_exists("test", $ruckusing_db_config)
        ) {
		...
		$logger->log('Test run started: ' . date('Y-m-d g:ia T') );
    } //setUp()
		
    public function testDbSchemaCreation()
    {
