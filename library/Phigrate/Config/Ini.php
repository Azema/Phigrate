 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Phigrate_Config_Ini extends Phigrate_Config
{
    /**
     ...
     * handler to convert any loading errors into a Phigrate_Exception_Config
     *
     * @param string $filename
     * @throws Phigrate_Exception_Config
     * @return array
    ...
    protected function _parseIniFile($filename)
    {
        ...
        if ($this->_loadFileErrorStr !== null) {
             ...
             */
            require_once 'Phigrate/Exception/Config.php';
            throw new Phigrate_Exception_Config($this->_loadFileErrorStr);
        }
