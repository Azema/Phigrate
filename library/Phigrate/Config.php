 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Phigrate_Config implements Countable, Iterator
{
    /**
     * Iteration index
     *
    ...
    /**
     * Phigrate_Config provides a property based interface to
     * an array. The data are read-only unless $allowModifications
     * is set to true on construction.
     *
     * Phigrate_Config also implements Countable and Iterator to
     ...
     * @param  string $name
     * @param  mixed  $value
     * @throws Phigrate_Config_Exception
     * @return void
     */
    public function __set($name, $value)
    {
        ...
        throw new Phigrate_Exception_Config('Phigrate_Config is read only');
    }

    /**
     * Deep clone of this instance to ensure that nested Phigrate_Configs
     * are also cloned.
     *
     * @return void
     */
    public function __clone()
    {
        ...
        foreach ($this->_data as $key => $value) {
            if ($value instanceof Phigrate_Config) {
